...
class Fragmentpublic : Fragment() {
    ...
    override fun onCreateView(
        ...
        var view = inflater.inflate(R.layout.fragment_public, container, false)
        add = view.findViewById(R.id.addevent001)
    ...
    private fun buildDialog() {
        ...
        date.setOnClickListener{
            DatePickerDialog(requireContext(),dataPicker,myCalendar.get(Calendar.YEAR),myCalendar.get(Calendar.MONTH),
        ...
        builder.setCustomTitle(title)
            .setPositiveButton("Save") { dialog, _ ->
                ...
                if(Hour==null||Minute==null|| DayOfMonth==null || Month==null || Year==null || type.isNullOrEmpty()){
                    ...
                    FancyToast.makeText(requireActivity(), "Event successfully added ", FancyToast.LENGTH_SHORT,FancyToast.SUCCESS , R.drawable.ic_event, false).show();
                    dialog.dismiss()
...
// Schedule the notification to be sent at the selected time
    ...
    fun saveEvent(eventName: String, descriptionText: String,time: String,Date:String,type: String) {
        val sharedPref = context?.getSharedPreferences("myPref12", Context.MODE_PRIVATE)
