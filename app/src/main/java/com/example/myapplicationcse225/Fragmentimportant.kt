...
class Fragmentimportant : Fragment() {
    ...
    override fun onCreateView(
        ...
        var view = inflater.inflate(R.layout.fragment_important, container, false)
        add = view.findViewById(R.id.addevent003)
        layout = view.findViewById(R.id.container003)
        buildDialog()
        loadEvents()
...
// Schedule the notification to be sent at the selected time
    ...
    fun saveEvent(eventName: String, descriptionText: String,time: String,Date:String,type: String) {
        val sharedPref = context?.getSharedPreferences("myPref11", Context.MODE_PRIVATE)
